    ...
    <section className="w-full text-center border-t border-b border-[#2d2a24] md:px-6 lg:px-0">
      <Link href="/contact">
        <div className="py-[120px] md:py-20 lg:py-[160px] px-[20px] md:px-0 md:border-b border-[#2d2a24]">
          <h1 className="font-poppins text-[56px] sm:text-6xl md:text-8xl lg:text-[100px] xl:text-[160px] [-webkit-text-stroke:1px_#2d2a24] md:[-webkit-text-stroke:2px_#2d2a24] font-semibold leading-[100%] tracking-[-4%] text-center">
